...
@Component({
  selector: 'app-loan-giving-debit-add',
  templateUrl: './loan-giving-debit-add.component.html',
  styleUrls: ['./loan-giving-debit-add.component.scss']
})
export class LoanGivingDebitAddComponent implements OnInit {
  ...
  onSubmit() {
    this.loading = true;
    this._loanGivingRecieveService.add_record(this.form.value)
      .subscribe(
        (next) => {

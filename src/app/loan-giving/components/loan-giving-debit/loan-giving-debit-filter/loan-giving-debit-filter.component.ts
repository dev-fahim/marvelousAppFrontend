...
@Component({
  selector: 'app-loan-giving-debit-filter',
  templateUrl: './loan-giving-debit-filter.component.html',
  styleUrls: ['./loan-giving-debit-filter.component.scss']
})
export class LoanGivingDebitFilterComponent implements OnInit {

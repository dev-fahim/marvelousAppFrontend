...
@Component({
  selector: 'app-loan-giving-debit-edit',
  templateUrl: './loan-giving-debit-edit.component.html',
  styleUrls: ['./loan-giving-debit-edit.component.scss']
})
export class LoanGivingDebitEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._loanGivingRecieveService.get_specific_record(this.uuid)
      .subscribe(
        (result) => {
          this.loading = false;
  ...
  onDelete() {
    ...
    this._loanGivingRecieveService.delete_record(this.uuid, this.form.value)
      .subscribe(
        (result) => {

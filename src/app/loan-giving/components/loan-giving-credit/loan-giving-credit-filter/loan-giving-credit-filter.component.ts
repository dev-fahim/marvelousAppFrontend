...
@Component({
  selector: 'app-loan-giving-credit-filter',
  templateUrl: './loan-giving-credit-filter.component.html',
  styleUrls: ['./loan-giving-credit-filter.component.scss']
})
export class LoanGivingCreditFilterComponent implements OnInit {

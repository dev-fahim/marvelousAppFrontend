...
@Component({
  selector: 'app-loan-giving-credit-add',
  templateUrl: './loan-giving-credit-add.component.html',
  styleUrls: ['./loan-giving-credit-add.component.scss']
})
export class LoanGivingCreditAddComponent implements OnInit {
  ...
  onSubmit() {
    if (this.form.valid) {
      this.loading = true;
      this._loanGivingService.add_funds(this.form.value)
        .subscribe(
